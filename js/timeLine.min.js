    ...
    t.fn.timeLine = function (e) {
      ...
      t(document).ready(function () {
        ...
        wow.sync();
            ...
            wow.config.callback = function(el){

            if(firstTriggered) return;

            // kiểm tra nếu item đầu tiên được trigger
            if(t(el).closest(".item").is(h.eq(0))){
                ...
                setTimeout(function(){
                    ...
                    // ép các element con animate luôn
                    t(el).find(".wow").each(function(){
                    wow.show(this);
                    });
                }, i * 400);
              ...
              t(window).scroll(function () {
                for (u = 0; u < f.length; u++)
                  "visible" != h.eq(u).css("visibility") ||
                    ...
                    (h.eq(u).addClass("done"), window.setTimeout(r, c * u, u));
              }),
              u = 0;
            u < f.length;
            u++
